...
public class HateoasViewV2<T> extends RepresentationModel<HateoasViewV2<T>> {
    ...
    public HateoasViewV2(Page<T> page) {
        this.page = page;
...
//        System.err.println(page.getContent().size());
    ...
    public HateoasViewV2(Page page, BiFunction<Integer, Integer, String> hrefGenerator) {
        this(page);
        generateStandardLinks(hrefGenerator);
    }

//    public HateoasViewV2 addLink(Link link, Relation relation) {
//        if (relation.additionPredicate.test(this.page)) {
//            add(link.withRel(relation.relValue));
//        }
//        return this;
//    }
//
//    public HateoasViewV2 addLink(String href, Relation relation) {
//        if (relation.additionPredicate.test(this.page)) {
//            add(Link.of(href).withRel(relation.relValue));
//        }
//        return this;
//    }
//
//    public HateoasViewV2 addLink(WebMvcLinkBuilder link, Relation relation) {
//        if (relation.additionPredicate.test(this.page)) {
//            add(link.withRel(relation.relValue));
//        }
//        return this;
//    }
    ...
    public void generateStandardLinks(BiFunction<Integer, Integer, String> hrefGenerator) {
